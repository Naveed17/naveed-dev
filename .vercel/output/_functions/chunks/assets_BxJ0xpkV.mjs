import { B as RemoteImageNotAllowed, C as LocalImageUsedWrongly, Q as AstroError, S as InvalidImageService, X as UnsupportedImageFormat, Y as UnsupportedImageConversion, c as ExpectedImageOptions, k as MissingImageDimension, l as ExpectedNotESMImage, s as ExpectedImage, v as IncompatibleDescriptorOptions } from "./errors-data_5N_gE6MK.mjs";
import { b as resolveSrc, c as isRemotePath, f as removeQueryString, g as inferRemoteSize, l as joinPaths, v as isESMImportedImage, x as isRemoteAllowed, y as isRemoteImage } from "./path_DuTGZoJv.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./build-service_COnefkgZ.mjs").catch((e) => {
...
//#endregion
export { getImage as n, baseService as r, getConfiguredImageService as t };
