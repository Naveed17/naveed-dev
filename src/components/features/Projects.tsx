...
const projects = [
  ...
  { title: "Playnox", image: "/playnox.png", link: "https://github.com/Naveed17/vbrae-admin", preview: "https://playnox.online/", status: "Contributor" },
...
export default function Projects() {
  return (
    <section id="projects" className="py-12 border-t border-border text-(--white)">
      <div className="max-w-5xl mx-auto">
        ...
        <a target="_blank" href="https://github.com/Naveed17?tab=repositories" aria-label="GitHub"
          className="w-full flex items-center justify-center gap-2 mt-9 text-(--white-icon) hover:text-(--white) transition duration-300 ease-in-out border border-(--white-icon-tr) p-3 rounded-full bg-surface hover:bg-surface-hover hover:scale-105">
