...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="cursor-pointer flex items-center justify-center size-9 rounded-xl border border-(--white-icon-tr) bg-surface text-(--white-icon) hover:text-(--white) hover:bg-surface-hover transition duration-300"
    >
      {dark ? (
